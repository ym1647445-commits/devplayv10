...
drop function if exists public.admin_update_platform_pricing(numeric,numeric,numeric,text,numeric,numeric,numeric,boolean,integer,numeric,numeric,numeric);
...
revoke all on function public.admin_update_platform_pricing(numeric,numeric,numeric,text,numeric,numeric,numeric,boolean,integer,numeric,numeric,numeric) from public;
grant execute on function public.admin_update_platform_pricing(numeric,numeric,numeric,text,numeric,numeric,numeric,boolean,integer,numeric,numeric,numeric) to authenticated;
